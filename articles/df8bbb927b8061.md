---
title: "Webページからデータを抽出するChrome拡張の作り方：DataPick開発記録とスクレイピング実装"
emoji: "📊"
type: "idea"
...
Webページからデータを集めたいことってありませんか。


商品の価格一覧を作りたいとか、求人情報をまとめたいとか、ニュースのタイトルを抽出したいとか。


でもスクレイピングってハードルが高い。Pythonでコードを書いて、セレクタを指定して、エラー処理して...。


もっと手軽にできないかなと思って、Chrome拡張を作りました。


[](#%E3%82%B9%E3%82%AF%E3%83%AC%E3%82%A4%E3%83%94%E3%83%B3%E3%82%B0%E3%81%AE%E9%9D%A2%E5%80%92%E3%81%95) スクレイピングの面倒さ

本業は普通の会社員なんですが、たまに「このサイトの情報をExcelにまとめたい」みたいな場面があります。


プライベートでもせどりをやっているので、価格情報を集めたいことが結構ある。


その度にPythonのスクリプトを書くのは面倒です。


サイトごとにHTML構造が違うから、毎回セレクタを調べないといけない。ページネーションがあったら対応が必要。動的に読み込まれるページだとさらに厄介。


ちょっとしたデータを集めたいだけなのに、準備に時間がかかりすぎる。


[](#%E3%83%96%E3%83%A9%E3%82%A6%E3%82%B6%E4%B8%8A%E3%81%A7%E5%AE%8C%E7%B5%90%E3%81%95%E3%81%9B%E3%81%9F%E3%81%8B%E3%81%A3%E3%81%9F) ブラウザ上で完結させたかった

考えたのは、ブラウザ上で直接データを選択して抽出できたら楽じゃないかということ。


見ているページで「ここのデータがほしい」とクリックすれば、同じ構造のデータを全部抜き出してくれる。


コードを書かなくても、視覚的に操作できる。


そういうツールがほしかった。


[](#%E6%8E%A2%E3%81%97%E3%81%9F%E3%81%91%E3%81%A9%E3%81%97%E3%81%A3%E3%81%8F%E3%82%8A%E3%81%93%E3%81%AA%E3%81%8B%E3%81%A3%E3%81%9F) 探したけどしっくりこなかった

似たようなツールはいくつかありました。


でも、有料だったり、機能が多すぎて複雑だったり、日本語対応が微妙だったり。


自分がほしいのは、シンプルにデータを抜き出してコピーできるだけのツール。
...
ページ上で要素をクリックすると、同じパターンのデータを自動で検出して抽出できるようにしました。


抽出したデータはCSVとかでエクスポートできる。


複雑なことはできないけど、ちょっとしたデータ収集には十分使える。


ローカルで処理するので、データがどこかに送信されることもない。プライバシー的にも安心です。


[](#%E6%8A%80%E8%A1%93%E7%9A%84%E3%81%AB%E3%82%84%E3%81%A3%E3%81%9F%E3%81%93%E3%81%A8) 技術的にやったこと

Chrome拡張からDOMを解析して、クリックした要素と同じ構造を持つ要素を探す。


これが意外と難しかった。


同じタグ、同じクラス、同じ階層構造のものを見つける処理。AIに相談しながら、パターンマッチングのロジックを組みました。


完璧ではないけど、8割くらいのケースでうまく動く。


[](#%E3%81%8A%E3%82%8F%E3%82%8A%E3%81%AB) おわりに

プログラミングなしでWebページからデータを抜き出したい人は試してみてください。


[https://chromewebstore.google.com/detail/datapick/epoehadeccangbpjldlbkapnakndbpkf](https://chromewebstore.google.com/detail/datapick/epoehadeccangbpjldlbkapnakndbpkf)


スクレイピングって、やりたいことに対して準備が重すぎるんですよね。


このツールで少しでもハードルが下がればいいなと思っています。
