...
本書はBook 1（無料）とシリーズ構成になっています。

| 本 | 価格 | 内容 |
|---|------|------|
| Book 1「AIで始めるChrome拡張 個人開発入門」 | 無料 | Claude/Cursor AIを使った最初の1本の作り方 |
| **本書（Book 3）「Chrome拡張 開発技術大全」** | **¥1,000** | **実装パターンの体系化・テスト・リリース自動化** |

¥1,000に値するのは、以下の理由からです。
...
- 収益化・マーケティング戦略→ 続刊「Chrome拡張を売るための戦略書」で扱っていましたが、現在は販売を停止しています
